...
/**
 * @typedef MFNodeProps
 * @property {number | null} currentSubList Sub list hiện tại.
 * @property {boolean | null} isChildrenRenderFirst Render `children` trước hay `values` trước?
 * @property {string | null} url Là đường dẫn của ảnh hoặc link.
 ...
 * @param {number | null} currentSubList Sub list hiện tại.
 * @param {boolean | null} isChildrenRenderFirst Render `children` trước hay `values` trước?
 * @param {string | null} url Là đường dẫn của ảnh hoặc link.
 ...
 * @param {Array<MFNodeProps> | null} children Là một mảng các MFNode.
 * @returns {MFNode}
 */
